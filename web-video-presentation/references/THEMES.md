...
| `guji-ink`           | 古籍·和風水墨 —— **墨当字**（暖近黑，非纯黑）+ 陈年宣纸暖白。唯一饱和色取**朱印红**。Noto Serif SC + Cormorant Garamond，2px 近直角框格。**极淡朱丝栏竖界行（120px）**是签名。hero 数字：上立衬线（非斜体）。宽书页 padding（140×96）。慢速书卷节奏（1.6s）。和風水墨主题，适合典籍导读 / 传统文化题材。 |
